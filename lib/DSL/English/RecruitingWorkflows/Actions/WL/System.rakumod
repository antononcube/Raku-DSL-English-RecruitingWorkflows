...
class DSL::English::RecruitingWorkflows::Actions::WL::System
    ...
    method introspection-data-retrieval ($/) {
        ...
        if $.userID.defined and $.userID.chars > 0 {
            ...
            make 'dsTalentProcurment[Select[' ~ ( $tiPred.chars > 0 ?? $tiPred ~ ' && ' ~ $userIDPred !! $userIDPred ) ~ '&]]'
        } else {
